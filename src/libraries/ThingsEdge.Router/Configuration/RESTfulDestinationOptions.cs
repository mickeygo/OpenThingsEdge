...
public sealed class RESTfulDestinationOptions
{
    ...
    /// </summary>
    public bool DisableCertificateValidationCheck { get; init; } = true;

    /// <summary>
    /// 目标服务健康检测地址，默认为 "/api/health"。
    /// </summary>
    public string? HealthRequestUrl { get; init; } = "/api/health";

    /// <summary>
    /// 目标服务接收数据的地址，默认为 "/api/iotgateway"。
    /// </summary>
    public string? RequestUrl { get; init; } = "/api/iotgateway";
