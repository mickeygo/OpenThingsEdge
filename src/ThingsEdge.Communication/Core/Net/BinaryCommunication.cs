...
public class BinaryCommunication
{
    ...
    public virtual OperateResult<byte[]> ReadFromCoreServer(byte[] send, bool hasResponseData, bool usePackAndUnpack)
    {
        ...
        var operateResult2 = CommunicationPipe.CommunicationLock.EnterLock(CommunicationPipe.ReceiveTimeOut);
        ...
        try
        {
            var operateResult3 = CommunicationPipe.OpenCommunication();
            ...
            {
                var operateResult4 = InitializationOnConnect();
    ...
    public virtual OperateResult<byte[]> ReadFromCoreServer(CommunicationPipe pipe, byte[] send, bool hasResponseData, bool usePackAndUnpack)
    {
        ...
        var operateResult2 = pipe.ReadFromCoreServer(GetNewNetMessage(), send, hasResponseData);
        if (!operateResult2.IsSuccess)
        {
        ...
        var operateResult3 = UnpackResponseContent(send, operateResult2.Content);
